...
Furthermore, the effect of $F$ and $\delta_c$ can be expressed as a combination of a linear $\mathbf{F}_l$ and non-linear $\mathbf{F}_{nl}$ correlations as follows:
